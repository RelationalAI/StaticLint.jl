...
struct StaticThread_Extension <: RecommendationExtendedRule end
...
function check(t::StaticThread_Extension, x::EXPR)
    msg ="Use `Threads.@threads :dynamic` instead of `Threads.@threads :static`. \
        Static threads must not be used as generated tasks will not be able to \
